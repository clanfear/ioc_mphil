...
* Social dynamics
   * e.g., norms, cohesion, efficacy
* Social activities
   * e.g., monitoring, formal control
* Presence of others
   * e.g., bonds, informal control
]

--
Environmental concepts:

* **Setting**: The environmen an individual perceives at a given moment
* **Activity field**: All the settings an individual experiences during some time of interest

---
# Boudon—Coleman Boat

Most ecological theories focus on environmental causes and aggregate outcomes, but crime happens in situations<br><br>
...
<br>*<strong>Mechanisms</strong> are important*
...
* Theory of delinquency rather than delinquent acts
...
* Bursik & Grasmick (1993)
   ...
   * Coordination needed across levels of control
