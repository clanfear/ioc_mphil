---
title: "Opportunity Theories"
subtitle: "Rational choice and routine activity"
...
Have you ever committed a crime (however minor) and why?<sup>1</sup>

&nbsp;

.footnote[[1] Though do exercise some discretion *wrt* self-incrimination]
...
What is the role of fairness in preventing crime?
...
* At **margin**, individuals act rationally
   * i.e., sensitive to incremental change
]
.pull-right-30[
![](img/cornish_clarke.jpg)
]
...
* **Marginal Deterrence**
   ...
   + *Does a 5 year sentence reduce more crime than a 4 year one?*
...
**Thin**: Consistent preferences

* Completeness
   * Can compare all alternatives
* Transitivity

--

**Thick**: Substantive values

* e.g., self-interest<sup>1</sup>

.footnote[[1] In this sense crim rat choice is *hella thicc*]
...
.center[
*Typically mute about the source of preferences*
]
...
* Motivation and decision-making (Today!)
* Social learning
* Subcultural theories
* Social organization of neighborhoods (Monday!)

--

Explained *differences* between individuals and groups well

Explained *changes* in national, area, and place crime rates poorly
...
Explicitly ecological: Offenders as *predators* feeding on society
...
Based on routine activity theory, how and why might \_\_\_\_\_ impact \_\_\_\_\_?


|                             | Social Media        | COVID-19            |
|-----------------------------|---------------------|---------------------|
| Gang Homicide               |  Group 1            | Group 6             |
| Auto Theft                  |  Group 3            | Group 4             |
| Intimate Partner Violence   |  Group 5            | Group 2             |

&nbsp;

Think in terms of **likely offenders**, **suitable targets**, and **capable guardians**.
...
Convergence is non-falsifiable postulate
...
* What does deterrence or rational choice neglect?

&nbsp;

* What would be evidence *against* rational choice?

&nbsp;

* What do you think about routine activity's ecological metaphor?

&nbsp;

* How might these theories steer policy wrong (or right)?
...
* Motivation and decision-making are only one element of crime

* **What do you want Monday to look like?**
