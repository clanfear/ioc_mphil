...
* You will receive updates and reminders as well as critical programme information via your Cambridge (@cam) email account throughout the year. Please do check this **regularly.**  
...
## Easter {.dark-slide background-image="img/logo-light.svg" background-size="auto 60px" background-position="right 15px bottom 15px"}
...
*You may attend more than two if you would like*
...
* Compulsory:
   * Academic Skills Development Workshops (Michaelmas)
   * Criminological Research Methods Workshops (Lent)
   * Cambridge Research Methods (CaRM) and IQA

* Optional:
   * Doing Prison Research (Lent term, optional)
...
Four modules across Michaelmas and Lent terms:

* At least three quantitative modules
   * In-house **Introduction to Quantitative Methods** is 2 units
      * Replaces: *Foundations in Applied Statistics* and *Basic Quantitative Analysis*
   * Many more; check their website!
* One additional module---qualitative recommended
* Each module is assessed independently, often on a pass/fail basis
...
## Attendance {background-image="img/logo-dark.svg" background-size="auto 60px" background-position="right 15px bottom 15px"}
...
## Attendance Required {background-image="img/logo-dark.svg" background-size="auto 60px" background-position="right 15px bottom 15px"}
...
## Research Ethics {background-image="img/logo-dark.svg" background-size="auto 60px" background-position="right 15px bottom 15px"}

* Read carefully the Handbook pp. 58--59 for details of the process regarding Ethics and Risk Assessment 
* If in doubt, ask the Graduate Administrator or your supervisor
* Compulsory seminar on risk assessment scheduled for tomorrow
* Compulsory seminar on research ethics in ASDW
...
* Referencing software, e.g., **Zotero**, EndNote, Mendeley
...
> We also carry out checks to identify the use of Generative AI in writing essays. A student using any unacknowledged content generated by artificial intelligence (e.g. ChatGPT) within a summative assessment, as though it is their own work, constitutes **academic misconduct**. When submitting your assignments and dissertation you will be required to confirm on your essay and dissertation submission forms what, if any, AI programmes you used in your writing process and how they were used.
